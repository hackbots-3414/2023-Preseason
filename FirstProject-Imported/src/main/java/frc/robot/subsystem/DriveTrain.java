...
public class DriveTrain extends SubsystemBase {
  ...
  public DriveTrain() {
    ...
    (left_front_motor.getSelectedSensorPosition() + left_back_motor.getSelectedSensorPosition())/2, 
    (right_front_motor.getSelectedSensorPosition() + right_back_motor.getSelectedSensorPosition())/2);
  }
  ...
  public void resetOdometry(Pose2d pose) {
    resetEncoders();
    m_odometry.resetPosition(my_ahrs.getRotation2d(), 
    (left_front_motor.getSelectedSensorPosition() + left_back_motor.getSelectedSensorPosition())/2, 
    (right_front_motor.getSelectedSensorPosition() + right_back_motor.getSelectedSensorPosition())/2, 
    pose);
  }
